<template>
  <!-- Navbar-->
  <nav class="navbar navbar-expand-lg navbar-light shadow-sm mb-3" style="background-color: #57f0d9">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <router-link :to="{ name: 'page.home' }" class="nav-link active" aria-current="page" href="#Home">Home Qur'an</router-link>
          </li>
          <li class="nav-item">
            <router-link :to="{ name: 'page.about' }" class="nav-link" href="#about">About Qur'an</router-link>
          </li>
          <li class="nav-item">
            <router-link :to="{ name: 'page.contact' }" class="nav-link" href="#contact">Contact Author</router-link>
          </li>
        </ul>
      </div>
    </div>
  ...
  <section class="header">
    <div class="display-5 text-center fw-bolder">
      <p class="title">Al-Qur'an Digital</p>
      <div class="display-6 text-center fs-6">
        <p class="intro fs-6">Al-Qur'an Digital 30 Juz dan Terjemahan Bahasa Indonesia Serta Audionya. </p>
      </div>
    </div>
  </section>
  <!-- Akhir header-->
